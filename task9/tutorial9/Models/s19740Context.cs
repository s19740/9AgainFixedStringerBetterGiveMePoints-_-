...
{
    public partial class s19740Context : DbContext
    {
        public s19740Context()
        {
        }

        public s19740Context(DbContextOptions<s19740Context> options)
            : base(options)
        {
        }
        //our tables in db
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Data Source=db-mssql;Initial Catalog=s19740;Integrated Security=True");
            }
        }
